...
**Current Version**: 1.3.3 (November 18, 2025)
- Critical bug fix: App-breaking script tag issue resolved
- Template literals now execute properly
- JavaScript execution fully restored
